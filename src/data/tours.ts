...
export const tours: Tour[] = [
  ...
  },
  {
    ...
    imgSrc: '/images/tour-secret-canyon.webp',
    imgAlt: 'Visitors at Horseshoe Bend overlook with the Colorado River bend far below',
    ctaHref: 'https://fareharbor.com/embeds/book/deerspringcanyontours/items/578554/?asn=fhdn&asn-ref=antelopecanyonaz&ref=antelopecanyonaz&bookable-only=yes&full-items=yes&marketplace=yes&flow=no&branding=no',
    featured: true,
  },
  {
    ...
    audience: 'All ages',
    href: '/tours/',
    bookingUrl: 'https://www.papillon.com/lake-powell-page/lake-powell-page-tours/skyview-horseshoe-bend-air-tour/?ref=vinpaitoon',
    imgSrc: '/images/tour-heli.webp',
    imgAlt: 'Red EcoStar helicopter on the tarmac at Page Municipal Airport with canyon mesas behind',
    ctaHref: 'https://www.papillon.com/lake-powell-page/lake-powell-page-tours/skyview-horseshoe-bend-air-tour/?ref=vinpaitoon',
    ctaTarget: '_blank',
    featured: true,
  },
  {
    ...
    audience: 'All ages',
    href: '/tours/',
    bookingUrl: 'https://www.papillon.com/lake-powell-page/lake-powell-page-tours/horseshoe-bend-flightseeing-tour/?ref=vinpaitoon',
    imgSrc: '/images/tour-air-scenic.webp',
    imgAlt: 'Red and white Papillon scenic flight plane in the air above the Colorado Plateau',
    ctaHref: 'https://www.papillon.com/lake-powell-page/lake-powell-page-tours/horseshoe-bend-flightseeing-tour/?ref=vinpaitoon',
    ctaTarget: '_blank',
    featured: true,
  },
];
